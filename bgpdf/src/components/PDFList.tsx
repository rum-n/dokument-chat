...
function PDFList({ pdfs, loading, onPDFSelect, onPDFDeleted, onRefresh }: PDFListProps): React.JSX.Element {
	const [deletingId, setDeletingId] = useState<string | null>(null);

	const handleDelete = async (pdfId: string): Promise<void> => {
		if (
			!confirm(
	...
	const handleDownload = async (pdfId: string, filename: string): Promise<void> => {
		try {
