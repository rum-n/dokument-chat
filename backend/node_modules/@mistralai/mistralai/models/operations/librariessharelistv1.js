...
/** @internal */
exports.LibrariesShareListV1Request$inboundSchema = z.object({
    library_id: z.string(),
}).transform((v) => {
...
/** @internal */
exports.LibrariesShareListV1Request$outboundSchema = z.object({
    libraryId: z.string(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
...
(function (LibrariesShareListV1Request$) {
    ...
    LibrariesShareListV1Request$.inboundSchema = exports.LibrariesShareListV1Request$inboundSchema;
    /** @deprecated use `LibrariesShareListV1Request$outboundSchema` instead. */
    LibrariesShareListV1Request$.outboundSchema = exports.LibrariesShareListV1Request$outboundSchema;
