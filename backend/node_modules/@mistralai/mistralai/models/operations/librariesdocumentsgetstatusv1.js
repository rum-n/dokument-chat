...
/** @internal */
exports.LibrariesDocumentsGetStatusV1Request$inboundSchema = z.object({
    library_id: z.string(),
...
/** @internal */
exports.LibrariesDocumentsGetStatusV1Request$outboundSchema = z.object({
    libraryId: z.string(),
    documentId: z.string(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
...
(function (LibrariesDocumentsGetStatusV1Request$) {
    ...
    LibrariesDocumentsGetStatusV1Request$.inboundSchema = exports.LibrariesDocumentsGetStatusV1Request$inboundSchema;
    /** @deprecated use `LibrariesDocumentsGetStatusV1Request$outboundSchema` instead. */
    LibrariesDocumentsGetStatusV1Request$.outboundSchema = exports.LibrariesDocumentsGetStatusV1Request$outboundSchema;
