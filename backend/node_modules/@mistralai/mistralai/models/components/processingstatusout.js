...
/** @internal */
exports.ProcessingStatusOut$inboundSchema = z.object({
...
/** @internal */
exports.ProcessingStatusOut$outboundSchema = z.object({
    documentId: z.string(),
...
(function (ProcessingStatusOut$) {
    /** @deprecated use `ProcessingStatusOut$inboundSchema` instead. */
    ProcessingStatusOut$.inboundSchema = exports.ProcessingStatusOut$inboundSchema;
    /** @deprecated use `ProcessingStatusOut$outboundSchema` instead. */
    ProcessingStatusOut$.outboundSchema = exports.ProcessingStatusOut$outboundSchema;
...
function processingStatusOutFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.ProcessingStatusOut$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ProcessingStatusOut' from JSON`);
}
//# sourceMappingURL=processingstatusout.js.map