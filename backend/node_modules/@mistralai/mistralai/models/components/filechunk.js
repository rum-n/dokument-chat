...
/** @internal */
exports.FileChunk$inboundSchema = z.object({
...
/** @internal */
exports.FileChunk$outboundSchema = z.object({
    type: z.literal("file").default("file"),
    fileId: z.string(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
...
(function (FileChunk$) {
    ...
    FileChunk$.inboundSchema = exports.FileChunk$inboundSchema;
    /** @deprecated use `FileChunk$outboundSchema` instead. */
    FileChunk$.outboundSchema = exports.FileChunk$outboundSchema;
...
function fileChunkFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.FileChunk$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'FileChunk' from JSON`);
}
