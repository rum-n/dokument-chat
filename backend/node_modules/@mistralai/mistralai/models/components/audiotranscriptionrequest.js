...
/** @internal */
exports.AudioTranscriptionRequest$inboundSchema = z.object({
    model: z.string(),
...
(function (AudioTranscriptionRequest$) {
    /** @deprecated use `AudioTranscriptionRequest$inboundSchema` instead. */
    AudioTranscriptionRequest$.inboundSchema = exports.AudioTranscriptionRequest$inboundSchema;
    /** @deprecated use `AudioTranscriptionRequest$outboundSchema` instead. */
    AudioTranscriptionRequest$.outboundSchema = exports.AudioTranscriptionRequest$outboundSchema;
...
function audioTranscriptionRequestFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.AudioTranscriptionRequest$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'AudioTranscriptionRequest' from JSON`);
}
