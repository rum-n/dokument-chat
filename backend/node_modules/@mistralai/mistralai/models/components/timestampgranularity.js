...
/** @internal */
exports.TimestampGranularity$inboundSchema = z.nativeEnum(exports.TimestampGranularity);
/** @internal */
...
(function (TimestampGranularity$) {
    /** @deprecated use `TimestampGranularity$inboundSchema` instead. */
    TimestampGranularity$.inboundSchema = exports.TimestampGranularity$inboundSchema;
    /** @deprecated use `TimestampGranularity$outboundSchema` instead. */
    TimestampGranularity$.outboundSchema = exports.TimestampGranularity$outboundSchema;
