...
const shareenum_js_1 = require("./shareenum.js");
/** @internal */
exports.SharingIn$inboundSchema = z.object({
    org_id: z.string(),
...
/** @internal */
exports.SharingIn$outboundSchema = z.object({
    orgId: z.string(),
...
(function (SharingIn$) {
    ...
    SharingIn$.inboundSchema = exports.SharingIn$inboundSchema;
    /** @deprecated use `SharingIn$outboundSchema` instead. */
    SharingIn$.outboundSchema = exports.SharingIn$outboundSchema;
...
function sharingInFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.SharingIn$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'SharingIn' from JSON`);
}
//# sourceMappingURL=sharingin.js.map