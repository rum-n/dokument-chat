...
/** @internal */
exports.DocumentTextContent$inboundSchema = z.object({
    text: z.string(),
});
/** @internal */
exports.DocumentTextContent$outboundSchema = z.object({
    text: z.string(),
});
/**
 * @internal
...
(function (DocumentTextContent$) {
    ...
    DocumentTextContent$.inboundSchema = exports.DocumentTextContent$inboundSchema;
    /** @deprecated use `DocumentTextContent$outboundSchema` instead. */
    DocumentTextContent$.outboundSchema = exports.DocumentTextContent$outboundSchema;
...
function documentTextContentFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.DocumentTextContent$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'DocumentTextContent' from JSON`);
}
