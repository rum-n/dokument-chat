...
/** @internal */
exports.TranscriptionStreamTextDeltaType$inboundSchema = z.nativeEnum(exports.TranscriptionStreamTextDeltaType);
/** @internal */
...
(function (TranscriptionStreamTextDeltaType$) {
    /** @deprecated use `TranscriptionStreamTextDeltaType$inboundSchema` instead. */
    TranscriptionStreamTextDeltaType$.inboundSchema = exports.TranscriptionStreamTextDeltaType$inboundSchema;
    /** @deprecated use `TranscriptionStreamTextDeltaType$outboundSchema` instead. */
    TranscriptionStreamTextDeltaType$.outboundSchema = exports.TranscriptionStreamTextDeltaType$outboundSchema;
...
(function (TranscriptionStreamTextDelta$) {
    /** @deprecated use `TranscriptionStreamTextDelta$inboundSchema` instead. */
    TranscriptionStreamTextDelta$.inboundSchema = exports.TranscriptionStreamTextDelta$inboundSchema;
    /** @deprecated use `TranscriptionStreamTextDelta$outboundSchema` instead. */
    TranscriptionStreamTextDelta$.outboundSchema = exports.TranscriptionStreamTextDelta$outboundSchema;
